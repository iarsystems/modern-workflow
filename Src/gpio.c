...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(OTG_HS_VBUSON_GPIO_Port, OTG_HS_VBUSON_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : SW2_OFF_Pin SW2_AUTO_Pin SW2_ON_Pin SW1_CLOSE_Pin */
  GPIO_InitStruct.Pin = SW2_OFF_Pin|SW2_AUTO_Pin|SW2_ON_Pin|SW1_CLOSE_Pin;
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_12
                          |GPIO_PIN_13|GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_6
  ...
  /*Configure GPIO pins : CAP_BUT1_Pin CAP_BUT2_Pin */
  GPIO_InitStruct.Pin = CAP_BUT1_Pin|CAP_BUT2_Pin;
  ...
  /*Configure GPIO pin : OTG_HS_VBUSON_Pin */
  GPIO_InitStruct.Pin = OTG_HS_VBUSON_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(OTG_HS_VBUSON_GPIO_Port, &GPIO_InitStruct);
